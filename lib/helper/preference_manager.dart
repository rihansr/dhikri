...
class PreferenceManager {
  ...
  set language(String locale) =>
      _preferenceManager.setString(_kLanguageKey, (locale ?? 'bn'));

  void setAdhkarProgress({@required var key, @required double progress}) =>
      _preferenceManager.setDouble('adhkar_${key}_key', progress ?? 0.0);
